...
from streaming.managers import Play
...
parser.add_argument(
    ...
    type=str,
    help="The flag of the channel you want to play",
)


async def play(update: Update, context: FartherContext):
    """
    Resume playback on the selected channel
    """
